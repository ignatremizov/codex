...
- When local test execution is explicitly authorized, run `just test -p codex-tui`.
  Otherwise, leave executable validation to remote CI and report it as pending.
