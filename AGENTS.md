...
- When monitoring long-running manual CI workflows or artifact transfers, use long poll intervals. A process poll returns immediately when the process exits, so avoid midpoint checks that do not affect the outcome.
