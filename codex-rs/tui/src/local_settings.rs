        ...
        Self {
            ...
            tui: Tui {
                ...
                exec_approval_notification_preview_graphemes: config
                    .tui_exec_approval_notification_preview_graphemes,
                user_input_notification_preview_graphemes: config
                    .tui_user_input_notification_preview_graphemes,
                show_compact_summary: config.show_compact_summary,
                diff_background: config.tui_diff_background,
                diff_add_bg: config.tui_diff_add_bg.clone(),
                diff_del_bg: config.tui_diff_del_bg.clone(),
