...
pub struct Cli {
    ...
    /// Disable temporary alternate-screen surfaces
    ///
    /// Normal conversation output is already inline; this prevents pickers, pagers, and other
    /// full-screen surfaces from switching terminal buffers.
