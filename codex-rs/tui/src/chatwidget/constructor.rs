...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            unified_exec_wait_tracker: None,
            ...
            mcp_activation: mcp_activation::McpActivation::default(),
        ...
        widget
            .bottom_pane
            .set_agent_spawn_models(widget.model_catalog.try_list_models().unwrap_or_default());
