...
impl ThreadGoalRequestProcessor {
    ...
    async fn thread_goal_set_inner(
        ...
        let skills = params.skills.as_ref().map(|skills| {
            skills
                .iter()
                .map(|skill| codex_protocol::protocol::GoalSkillSelection {
        ...
        let outcome = self
            ...
            .set_thread_goal(
                ...
                GoalSetRequest {
                    ...
                    skills: skills
                        .as_deref()
                        .map(GoalSkillSelectionsUpdate::Set)
                        .unwrap_or(GoalSkillSelectionsUpdate::Keep),
