            ...
            match action {
                AgentControlAction::Spawn {
                    ...
                    Ok(AgentControlOutcome::Spawned {
                        ...
                        input_outcome: result.input_outcome.map(agent_input_outcome),
                ...
                AgentControlAction::Prompt {
                    ...
                    Ok(AgentControlOutcome::Prompted {
                        ...
                        input_outcome: agent_input_outcome(result.input_outcome),
                        post_admission_warning: result.post_admission_warning,
                    })
                }
                ...
                AgentControlAction::Interrupt {
                    ...
                    Ok(AgentControlOutcome::Interrupted {
                        ...
                        input_outcome: result
                            .as_ref()
                            .map(|result| agent_input_outcome(result.input_outcome)),
            ...
            Ok(outcome) => {
                ...
                if matches!(
                    ...
                    AgentControlOutcome::Spawned {
                        ...
                        input_outcome: AgentInputOutcome::Unknown,
                        ..
                    } | AgentControlOutcome::ReservedPrompted {
                        input_outcome: AgentInputOutcome::Unknown,
                        ..
                    } | AgentControlOutcome::Interrupted {
                        input_outcome: Some(AgentInputOutcome::Unknown),
                        ..
                    }
                ) {
