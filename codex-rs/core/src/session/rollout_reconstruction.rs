...
impl Session {
    pub(super) async fn reconstruct_history_from_rollout(
            ...
            && let Some(base_replacement_history) = &base_compacted_item.replacement_history
        {
            ...
            history.restore_guardian_history(base_compacted_item.guardian_history.as_ref());
        }
        ...
        if repair_checkpoint_source.is_some() {
            let replay_sanitization = sanitize_annotated_compacted_media_prefix(
...
fn sanitize_annotated_compacted_media_prefix(
