...
impl AvailableSkillsInstructions {
    ...
    pub(crate) fn with_promoted(mut self, promoted: Vec<PromotedSkillIdentity>) -> Self {
        self.promoted = bounded_promoted_identities(promoted);
        self
    }
...
impl ContextualUserFragment for AvailableSkillsInstructions {
    ...
    fn body(&self) -> String {
        ...
        let inventory = render_available_skills_body(
            self.prompt_kind,
