...
impl GoalToolExecutor {
    ...
    async fn handle_create(
        ...
        self.runtime.activate_goal_skill_selections_at_revision(
            revision,
            goal.goal_id.clone(),
            Vec::new(),
        );
        ...
        if !self.runtime.is_enabled() {
            ...
            self.runtime.clear_goal_skill_activations();
        }
    ...
    async fn handle_update(
        ...
        let goal = protocol_goal_from_state(goal);
        self.runtime
            .clear_goal_skill_activations_at_revision(revision, InactiveGoalHistory::Invalidate);
            ...
            codex_state::GoalAccountingOutcome::Updated(goal) => {
                if previous_status != Some(goal.status) {
                    ...
                    if goal.status != codex_state::ThreadGoalStatus::Active {
                        self.runtime.clear_goal_skill_activations_at_revision(
                            revision,
