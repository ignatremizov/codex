...
pub struct AgentControlResponse {
    ...
    /// The operation has a committed or indeterminate outcome, but its source audit failed.
    pub audit_warning: Option<String>,
}

/// Whether a user input submission is known to have been admitted.
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
...
/// Outcome of a user-authored operation; input may be admitted or indeterminate after enqueue.
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, JsonSchema, TS)]
#[serde(
    tag = "type",
    rename_all = "camelCase",
...
pub enum AgentControlOutcome {
    Spawned {
        ...
        /// Non-retryable degradation after child input admission or uncertain routing.
    ...
    Prompted {
        ...
        /// Non-retryable degradation after target input admission or uncertain routing.
        post_admission_warning: Option<String>,
    },
    ReservedPrompted {
        target_thread_id: String,
        submission_id: String,
        input_outcome: AgentInputOutcome,
        /// The admitted target turn when routing can prove it; null means the input outcome
        /// is indeterminate after enqueue and must not be retried automatically.
        turn_id: Option<String>,
        /// Non-retryable degradation after target input admission, including an indeterminate
        /// target turn after enqueue.
        post_admission_warning: Option<String>,
    },
    Resumed {
        target_thread_id: String,
    ...
    Interrupted {
        ...
        input_outcome: Option<AgentInputOutcome>,
        /// Non-retryable degradation after follow-up input admission or uncertain routing.
        post_admission_warning: Option<String>,
    },
    Closed {
        target_thread_id: String,
