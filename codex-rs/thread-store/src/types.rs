...
pub struct LoadSubAgentCompletionContextItemParams {
    ...
    /// Whether archived threads are eligible.
    pub include_archived: bool,
    /// Stable reserved identity of the accepted delivery.
...
pub struct LoadSubAgentCompletionPresentationParams {
    ...
    /// Whether archived threads are eligible.
    pub include_archived: bool,
    /// Stable canonical identity bound before the first publication write.
    pub item_id: String,
...
pub struct StoredSubAgentCompletionPresentation {
    /// The matching trusted presentation visible in history, not a durability acknowledgement.
